...
public class CoolOrNot {
	...
	private static final String DATABASE_NAME = "CoolOrNotdb";
	...
	public CoolOrNot(Context c) {
		ourContext = c;
	}

	public CoolOrNot open() throws SQLException {
	...
	public void creatEntry(String name, String hotness) {
		// TODO Auto-generated method stub
